                ...
                <div class="leadership-type flc fc mt35">
                  <div class="page-13-sub-image-1 flex">
                    ...
                    <div class="flc fc type-block-container">
                      <div class="flc">
                        <div class="block active">지원형</div>
                        <div class="block">코칭형</div>
                      </div>
                      <div class="flc">
                  ...
                  <div class="p0-27 mt50">
                    <div class="pr-title">나의 리더십 유형</div>
                    ...
                    <div class="text-container">
                      <div class="mb30 mt30">
                        ...
                        <div class="main-sub-title mb10">특징</div>
                        <ul>
                          <li>
                      ...
                      <div class="mb30">
                        <div class="main-sub-title mb10">강점</div>
                        <ul>
                          <li>
                      ...
                      <div class="mb30">
                        <div class="main-sub-title mb10">주의할 점</div>
                        <ul>
                          <li>
              ...
              <div className="w-50 h-100 flex jcs mt50">
                <div className="flc fc">
                  <div className="page-13-sub-image-1">
                    <div class="leadership-style-label flc">
                      <p></p>
                      <div class="fwb f14 ml5">리더십 스타일</div>
                    </div>
