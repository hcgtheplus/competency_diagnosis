                  ...
                  <tbody className="lecture-list-table">
                    ...
                    <tr className="tc">
                      ...
                      <td className="tl">
                        <div className="flex">
                          <div className="mr8">-</div>
                          Driving change: The power of Ubuntu | Jordan Levy |
                          TEDxASL
                        </div>
                      </td>
                      <td rowSpan={2}>개혁자</td>
                    ...
                    <tr className="tc">
                      ...
                      <td className="tl">
                        <div className="flex">
                          <div className="mr8">-</div>
                          ‘변화를 주도하는 리더 변화에 휩쓸리는 리더’ | 김진혁
                          지음
                        </div>
                        <div className="flex">
                          <div className="mr8">-</div>
                          ‘최고의 리더는 어떻게 변화를 이끄는가’ | 기무라
                          나오노리 지음
                        </div>
                        <div className="flex">
                          <div className="mr8">-</div>
                    ...
                    <tr className="tc">
                      ...
                      <td className="tl">
                        <div className="flex">
                          <div className="mr8">-</div>
                          USArmyWarCollege, Strategic Decision Making - Retired
                          Gen. George Casey
                        </div>
                        <div className="flex">
                          <div className="mr8">-</div>
                    ...
                    <tr className="tc">
                      ...
                      <td className="tl">
                        <div className="flex">
                          <div className="mr8">-</div>
                          ‘마이클 포터의 경쟁전략’ | 마이클 포터 지음
                        </div>
                        <div className="flex">
                          <div className="mr8">-</div>
                          ‘세계 최고의 CEO는 어떻게 일하는가 | 캐롤린 듀어, 스콧
                          켈러, 비크람 말호트라 지음
                        </div>
                        <div className="flex">
                          <div className="mr8">-</div>
