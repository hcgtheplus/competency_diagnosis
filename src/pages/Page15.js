...
export default function Page({ data, subData }) {
  const leadershipType = data[0].Column6.split("X")[0].split("(")[0].trim();
  const leadershipStyle = data[0].Column6.split("X")[1].split("(")[0].trim();
        ...
        <div className="need-data-container">
          <div className="for-margin">
            <div className="user-info">
              ...
              <div className="department">{subData[1].Column6}</div>

              <div className="sub-title">직책:</div>
              <div className="duty">{subData[2].Column6}</div>

              <div className="user-name">{subData[0].Column6}</div>
            </div>
